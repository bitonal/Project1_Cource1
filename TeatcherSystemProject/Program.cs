...
namespace TeacherSystemProject_Cource1
{
    class Program
    {
        public static string fileLocation = "C:/Users/Dell/source/repos/TeacherSystemProject_Cource1/TeacherSystemProject_Cource1/TeatchersRecords/TeachersSystem.txt";
        ...
        static void Main(string[] args)
        {
            while (true)
            {
                ...
                Console.WriteLine(" 2  to update existing data  ");
                Console.WriteLine(" 3  to display teacher records");
